...
export default {
  ...
  // Shared by the file list and the parse history — one job status, one set of words.
  status: {
    queued: 'Queued',
    running: 'Running',
    succeeded: 'Succeeded',
  ...
  files: {
    headTitle: 'Files',
    counts: '{folders} folders · {files} files',
    root: 'Home',
    tree: 'Folders',
    ...
    deleteFileConfirm: 'Delete “{name}”? The parse itself stays in your history.',
    deleteFolder: 'Delete folder',
    deleteFolderConfirm:
      'Delete “{name}” and everything inside it? The parses themselves stay in your history.',
    tooLarge: '“{name}” is bigger than the {limit} upload limit.',
    unsupported: '“{name}” is not a PDF or an image.',
  },
  viewer: {
    views: 'Result view',
    view: {
    ...
    meta: '{model} · {pages} pages · bbox {bbox}',
    empty: 'Nothing to show yet.',
    emptyBody: 'This job has not produced any markdown — check the JSON view for what came back.',
    degraded:
  ...
  history: {
    ...
    columnPages: 'Pages',
    empty: 'No parses yet.',
    emptyBody: 'Every document parsed — in Files, over the API or through the connector — is listed here.',
  },
}
